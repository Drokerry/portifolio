const opcao = document.getElementsByClassName("opcao") as HTMLCollection;
const buttonRestart = document.getElementById("btnRestart") as HTMLButtonElement;
...
const bCheckbox = document.getElementById("bCheckbox") as HTMLInputElement;
const buttonResetPontuacao = document.getElementById(
  "btnResetPontuacao"
) as HTMLButtonElement;
const elModo = document.getElementById("modo") as HTMLSelectElement;
...
let elScoreP1 = document.getElementById("nScoreP1") as HTMLSpanElement;
let elScoreP2 = document.getElementById("nScoreP2") as HTMLSpanElement;
let elScoreP3 = document.getElementById("nScoreP3") as HTMLSpanElement;
let cScoreP1 = document.getElementById("cScoreP1") as HTMLSpanElement;
let cScoreP2 = document.getElementById("cScoreP2") as HTMLSpanElement;
let nScoreP1 = 0;
let nScoreP2 = 0;
let nScoreP3 = 0;
let lBot = false;
...
function modoDificil(aLivre: any) {
  let nCode = -1;
...
function mudouModo(this: HTMLSelectElement) {
